...
contract product {
    ...
    bytes32 storedConsumerCode = productsSold[_productSN];
    require(storedConsumerCode.length > 0, "Product not found in sold records");
    return storedConsumerCode == _consumerCode;
}
